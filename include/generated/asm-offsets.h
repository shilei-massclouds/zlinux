...
#define TASK_THREAD_RA 288 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 296 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 304 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 312 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 320 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 328 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 336 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 344 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 352 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 360 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 368 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 376 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 384 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 392 /* offsetof(struct task_struct, thread.s[11]) */
