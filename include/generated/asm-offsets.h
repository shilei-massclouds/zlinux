...
#define TASK_THREAD_RA 280 /* offsetof(struct task_struct, thread.ra) */
#define TASK_THREAD_SP 288 /* offsetof(struct task_struct, thread.sp) */
#define TASK_THREAD_S0 296 /* offsetof(struct task_struct, thread.s[0]) */
#define TASK_THREAD_S1 304 /* offsetof(struct task_struct, thread.s[1]) */
#define TASK_THREAD_S2 312 /* offsetof(struct task_struct, thread.s[2]) */
#define TASK_THREAD_S3 320 /* offsetof(struct task_struct, thread.s[3]) */
#define TASK_THREAD_S4 328 /* offsetof(struct task_struct, thread.s[4]) */
#define TASK_THREAD_S5 336 /* offsetof(struct task_struct, thread.s[5]) */
#define TASK_THREAD_S6 344 /* offsetof(struct task_struct, thread.s[6]) */
#define TASK_THREAD_S7 352 /* offsetof(struct task_struct, thread.s[7]) */
#define TASK_THREAD_S8 360 /* offsetof(struct task_struct, thread.s[8]) */
#define TASK_THREAD_S9 368 /* offsetof(struct task_struct, thread.s[9]) */
#define TASK_THREAD_S10 376 /* offsetof(struct task_struct, thread.s[10]) */
#define TASK_THREAD_S11 384 /* offsetof(struct task_struct, thread.s[11]) */
